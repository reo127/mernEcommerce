                ...
                <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                    <fieldset className="w-full space-y-1 text-gray-800">
                        ...
                        <div className="relative">
                            ...
                            <input type="search" name="Search" placeholder="Search..." className="w-72 py-2 pl-10 text-sm rounded-md  focus:outline-none bg-gray-100 text-gray-800 focus:bg-gray-50 focus:border-blue-600" />
                        </div>
                    </fieldset>
                </nav>
                <div className="">
